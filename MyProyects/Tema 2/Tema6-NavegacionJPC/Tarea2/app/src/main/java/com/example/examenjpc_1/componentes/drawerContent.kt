...
fun DrawerContent(onDestinationClicked: (String) -> Unit) {
    ...
    val items = listOf(
        NavigationItem("Inicio", Ruta.Inicio.ruta, Icons.Filled.Home, Icons.Outlined.Home),
        NavigationItem("Formulario", Ruta.Formulario.ruta, Icons.Filled.Person, Icons.Outlined.Person),
        NavigationItem("ListadoDetalle", Ruta.ListadoDetalle.ruta, Icons.Filled.Settings, Icons.Outlined.Settings)
    )
